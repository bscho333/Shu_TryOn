...
# Code copied from https://github.com/huggingface/diffusers/blob/4f14b363297cf8deac3e88a3bf31f59880ac8a96/src/diffusers/models/autoencoder_kl.py
# We modified the original code to use the EMASC module during decoding
